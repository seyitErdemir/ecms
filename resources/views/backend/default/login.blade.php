...
<head>
  ...
  <![endif]-->
    ...
    <style type="text/css">
    .login-page {
        background: url(/images/settings/xxxxx.jpg) no-repeat center center fixed;
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{route('nedmin.Login')}}" style="color: white;"><b>...</b>Yazılım</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Kullanıcı ve Şifrenizi Giriniz</p>
