                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Use class <code>&lt;i class="bx bx-**">&lt;/i></code>
                            </p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc mb-2">Use
                                <code>&lt;i class="fas fa-ad"&gt;&lt;/i&gt;</code> <span class="badge bg-success">v 5.13.0</span>.
                            </p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc mb-2">Use
                                <code>&lt;i class="far fa-address-book"&gt;&lt;/i&gt;</code> <span class="badge bg-success">v 5.13.0</span>.
                            </p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc mb-2">Use
                                <code>&lt;i class="fab fa-500px"&gt;&lt;/i&gt;</code> <span class="badge bg-success">v 5.13.0</span>.
                            </p>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row icon-demo-content">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-45 mdi-account"></i>mdi mdi-rotate-45
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-90 mdi-account"></i>mdi mdi-rotate-90
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-135 mdi-account"></i>mdi mdi-rotate-135
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-180 mdi-account"></i>mdi mdi-rotate-180
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-225 mdi-account"></i>mdi mdi-rotate-225
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-270 mdi-account"></i>mdi mdi-rotate-270
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-rotate-315 mdi-account"></i>mdi mdi-rotate-315
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row icon-demo-content">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-spin mdi-loading"></i>mdi mdi-spin
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <i class="mdi mdi-spin mdi-star"></i>mdi mdi-spin
                                </div>
                            </div>
                        </div>
                    </div>
